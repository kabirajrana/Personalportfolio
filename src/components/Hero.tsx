      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-center md:items-end">
          <div className="relative group mb-6">
            ...
            <div 
              className={`relative w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-gradient-to-r from-cyan-400 to-purple-600 bg-gradient-to-br from-gray-700 to-gray-900 group-hover:scale-105 transition-all duration-500 animate-float cursor-pointer ${
            ...
            >
              <img 
                ...
                className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 ${
                  isPhotoClicked ? 'scale-125' : 'scale-100'
                }`}
              />
